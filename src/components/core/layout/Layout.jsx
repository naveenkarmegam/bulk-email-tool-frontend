...
<main id="page-top" >
{/* <div> */}
  <svg xmlns="http://www.w3.org/2000/svg" className="d-none z-0">
  ...
  <div className="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle z-0">
    ...
    <ul className="dropdown-menu dropdown-menu-end shadow z-0" aria-labelledby="bd-theme-text">
      <li>
